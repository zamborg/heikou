...
var allowedImports = map[string][]string{
	"cmd/h": {
		...
		"internal/heikou", "internal/home", "internal/runner", "internal/supervisor",
		"internal/ui", "internal/workstream",
	...
	"internal/ui": {
		"internal/config", "internal/control", "internal/format",
		"internal/heikou", "internal/runner", "internal/workstream",
	},
